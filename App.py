...
st.title(':green[SKILLMATCH:-] :grey[AI assisted skill matching tool]')

st.markdown(':green[This application will match and analyze your resume and the job description provided]')

tips = '''
Follow these steps:-
1. Upload the resumme (PDF Only) in side bar.
